...
public class HibernateUtil {
    ...
    static {
        try {
            ...
            settings.put(Environment.URL, "jdbc:postgresql://pellefant.db.elephantsql.com:5432/xhcdhcqe");
            settings.put(Environment.USER, "xhcdhcqe");
            settings.put(Environment.PASS, "SzFXmEuOsCUQx63lqllxxRkoU0_Aj7qW");
